                ...
                <div>
                    ...
                    <div x-show="mode === 'email'" x-cloak>
                        <input
                            ...
                            class="w-full px-4 py-3 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 @error('login') border-red-400 bg-red-50 @else border-gray-200 @enderror">
                    </div>
