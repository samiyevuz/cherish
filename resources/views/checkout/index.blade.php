...
@section('title', 'Buyurtma berish — CherishStyle')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-8">
        ...
        <a href="{{ route('cart.index') }}" class="hover:text-gray-900 transition-colors">Savat</a>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-900 font-medium">Buyurtma berish</span>
    </nav>

    <h1 class="text-2xl sm:text-3xl font-black text-gray-900 mb-8">Buyurtmani rasmiylashtirish</h1>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white border border-gray-100 rounded-2xl p-6">
                    <h2 class="text-base font-bold text-gray-900 mb-5">Yetkazib berish ma'lumotlari</h2>
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-amber-800 mb-1">To'lov usuli</p>
                            <p class="text-xs text-amber-700">Buyurtma yetkazib berilganda naqd pul yoki plastik karta orqali to'lov qilinadi.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-gray-100 rounded-2xl p-6 sticky top-24">
                    <h2 class="text-base font-bold text-gray-900 mb-5">Buyurtma xulosasi</h2>
                    ...
                    <div class="border-t border-gray-100 pt-4 space-y-3 text-sm">
                        <div class="flex justify-between text-gray-600">
                            ...
                            <span>{{ number_format($cart->total, 0, '.', ' ') }} so'm</span>
                        </div>
                        <div class="flex justify-between text-gray-600">
                            <span>Yetkazib berish</span>
                            <span>{{ number_format($deliveryPrice, 0, '.', ' ') }} so'm</span>
                        </div>
                        <div class="border-t border-gray-100 pt-3 flex justify-between">
                            <span class="font-bold text-gray-900">Jami</span>
                            <span class="font-black text-lg text-gray-900">{{ number_format($cart->total + $deliveryPrice, 0, '.', ' ') }} so'm</span>
                        </div>
                    </div>
