@extends('layouts.app')
@section('title', __('app.success_heading') . ' — CherishStyle')
@section('content')
<div class="max-w-xl mx-auto px-4 py-20 text-center">
    ...
    <h1 class="text-2xl font-black text-gray-900 mb-2">{{ __('app.success_heading') }}</h1>
    <p class="text-gray-500 text-sm mb-6">{{ __('app.success_desc') }}</p>

    <div class="bg-gray-50 rounded-2xl p-6 mb-8">
        <p class="text-sm text-gray-600 mb-2">{{ __('app.success_order_num') }}</p>
